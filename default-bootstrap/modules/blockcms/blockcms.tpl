...
{else}
	...
	<section class="bottom-footer col-xs-12">
		<div>
			{l s='[1] %3$s %2$s - All rights reserved. %1$s [/1]' mod='blockcms' sprintf=['Lluchus™', 'Y'|date, '©'] tags=['<a class="_blank" href="http://lluchus.com/index.php?id_cms=4&controller=cms">'] nocache}
		</div>
	</section>
	{/if}
	<!-- /Block CMS module footer -->
